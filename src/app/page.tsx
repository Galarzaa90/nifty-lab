    ...
    <Container size="lg" py="xl">
      <Stack gap="xl">
        <Stack gap="xs">
          ...
          <Text c="dimmed">
            Compare everyday items by converting prices into a common unit of
            measure.
          </Text>
        </Stack>
          ...
          {products.map((product, index) => {
            ...
            return (
              <Card
                ...
                p="lg"
                bg={
                  isCheapest ? "var(--mantine-color-teal-0)" : undefined
                }
                style={
                  cardBorderColor
              ...
              >
                <Stack gap="md">
                  <Group gap="xs" justify="space-between">ø
                    <Group gap="xs" align="center">

                      {normalized
                        ? <Badge color={badgeColor} variant="light" radius="sm">`${currencyFormatter.format(
                          normalized.pricePerBase
                        )} / ${normalized.baseUnitLabel}`</Badge>
                        : null}
                    ...
                    >
                      {products.length <= 2 ? <IconTrashOff /> : <IconTrash />}
                    </ActionIcon>
                  </Group>
